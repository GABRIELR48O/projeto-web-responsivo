...
btn.addEventListener("click", () => {
  ...
  const semRepetir = document.getElementById("semRepetir").const btn = document.getElementById("btnSortear");
const resultado = document.getElementById("resultado");
const erro = document.getElementById("erro");
...
btn.addEventListener("click", () => {
  ...
  if (!quantidade || !min || !max) {const btn = document.getElementById("btnSortear");
const resultado = document.getElementById("resultado");
const erro = document.getElementById("erro");
